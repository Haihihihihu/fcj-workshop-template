...
![RDS final_alerts evidence](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/10-rds-final-alerts-evidence.png)
...
![Terminate backend and worker instances](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/01-ec2-terminate-backend-worker.png)
...
![Delete ALB action](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/02-alb-delete-menu.png)

![Confirm ALB deletion](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/03-alb-delete-confirm.png)

![Delete target group](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/04-target-group-delete-menu.png)
...
![Main SQS queue deleted](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/05-sqs-main-queue-deleted.png)

![DLQ deleted](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/06-sqs-dlq-deleted.png)
...
![S3 data bucket content before deletion](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/07-s3-data-bucket-contents.png)

![S3 delete objects status](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/08-s3-delete-objects-status.png)

![S3 buckets deleted](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/09-s3-buckets-deleted.png)
...
![Delete RDS with final snapshot](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/11-rds-delete-final-snapshot.png)

![RDS delete confirmation](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/12-rds-delete-confirmation.png)

![RDS deleted](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/13-rds-deleted.png)
...
![Secrets Manager list before deletion](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/14-secrets-manager-list.png)

![Secret metadata before delete](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/15-secret-before-delete.png)

![Secret scheduled for deletion](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/16-secret-scheduled-deletion.png)
...
![CloudFront distributions disabled but under Pro plan](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/17-cloudfront-distributions-disabled-pro-plan.png)
...
![Only default behavior remains](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/18-cloudfront-default-behavior-only.png)

*Caption:* Ordered behaviors đã được giảm còn required `Default (*)`. Default
behavior không thể xóa độc lập.

![CloudFront OAC retained](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/19-cloudfront-oac-retained.png)

*Caption:* OAC vẫn được giữ lại vì distribution còn tồn tại và vẫn reference
origin/OAC.

![CloudFront-created WAF protection pack](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/20-waf-created-by-cloudfront-pro-plan.png)
...
![IAM Identity Center users with MFA](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/21-iam-identity-center-users-mfa.png)

![IAM Identity Center groups before deletion](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/22-iam-identity-center-groups-before-delete.png)

![IAM Identity Center groups deleted](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/23-iam-identity-center-groups-deleted.png)
...
![CloudWatch log groups before deletion](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/24-cloudwatch-log-groups-before-delete.png)

![CloudWatch alarms before deletion](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/25-cloudwatch-alarms-before-delete.png)

![Delete CloudWatch log groups](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/26-cloudwatch-delete-log-groups-dialog.png)
...
![Delete VPC endpoint](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/27-vpc-endpoint-delete.png)

![Delete NAT Gateway](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/28-nat-gateway-delete.png)

![Release Elastic IP](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/29-release-elastic-ip.png)
...
![Delete route table](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/30-route-table-delete.png)

![Route table cleanup complete](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/31-route-table-cleanup-complete.png)

![VPC subnets before deletion](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/32-vpc-subnets-before-delete.png)

![Delete security group](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/33-security-group-delete.png)

![Internet Gateway before deletion](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/34-internet-gateway-before-delete.png)

![Delete Internet Gateway](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/35-internet-gateway-delete.png)

![VPC deletion complete](/fcj-workshop-template/images/5-Workshop/5.11-Cleanup/socai-cleanup/36-vpc-delete-complete.png)
