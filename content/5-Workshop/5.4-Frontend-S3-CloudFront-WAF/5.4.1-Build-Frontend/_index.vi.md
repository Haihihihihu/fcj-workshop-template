...
![Frontend source folder](/fcj-workshop-template/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-01-frontend-folder.png)
...
![Frontend environment ](/fcj-workshop-template/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-02-frontend-env.png)

Build output xác nhận frontend compile thành công.

![Frontend build success](/fcj-workshop-template/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-03-frontend-build-success.png)

Thư mục `dist/` là artifact sẽ được upload lên S3 Static Frontend Bucket.

![Frontend dist folder](/fcj-workshop-template/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-04-frontend-dist-folder.png)
