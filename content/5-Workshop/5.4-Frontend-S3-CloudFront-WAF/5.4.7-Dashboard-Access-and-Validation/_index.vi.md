...
![Dashboard CloudFront home](/fcj-workshop-template/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-38-dashboard-cloudfront-home.png)
...
![Curl CloudFront 200](/fcj-workshop-template/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-43-curl-cloudfront-200.png)

DevTools static asset evidence xác nhận JavaScript và CSS bundle load thành công.

![DevTools static assets 200](/fcj-workshop-template/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-57-devtools-static-assets-200.png)
...
![DevTools API call mock or real](/fcj-workshop-template/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-58-devtools-api-call-mock-or-real.png)

Console screenshot giúp xác nhận không có lỗi browser nghiêm trọng sau khi deploy.

![DevTools console warnings](/fcj-workshop-template/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-60-devtools-console-warnings.png)
...
![API behavior ](/fcj-workshop-template/images/5-Workshop/5.4-Frontend-S3-CloudFront-WAF/w-phu-26-api-behavior-placeholder.png)
