...
![Frontend mock mode environment](/fcj-workshop-template/images/5-Workshop/5.9-AI-Fusion-and-Dashboard-Validation/w-phu-44-frontend-env-mock-mode.png)
...
![Frontend real API environment ](/fcj-workshop-template/images/5-Workshop/5.9-AI-Fusion-and-Dashboard-Validation/w-phu-45-frontend-env-real-api-redacted.png)

Mock status evidence phù hợp để validate UI, nhưng không được mô tả là live telemetry.

![Dashboard API status mock](/fcj-workshop-template/images/5-Workshop/5.9-AI-Fusion-and-Dashboard-Validation/w-phu-46-dashboard-api-status-mock.png)
...
![Dashboard API status real](/fcj-workshop-template/images/5-Workshop/5.9-AI-Fusion-and-Dashboard-Validation/w-phu-47-dashboard-api-status-real.png)
