...
![SQS main queue detail](/fcj-workshop-template/images/5-Workshop/5.6-SQS-DLQ-and-S3-Data-Bucket/w-tin-01-sqs-main-queue-detail.png)
...
![SQS main queue configuration](/fcj-workshop-template/images/5-Workshop/5.6-SQS-DLQ-and-S3-Data-Bucket/w-tin-02-sqs-main-configuration.png)

## Bước 3: Xác minh DLQ

Mở DLQ `socai-dev-normalized-zeek-events-dlq`. Queue này lưu message xử lý lỗi sau số lần retry đã cấu hình.

![SQS DLQ detail](/fcj-workshop-template/images/5-Workshop/5.6-SQS-DLQ-and-S3-Data-Bucket/w-tin-03-sqs-dlq-detail.png)
...
![SQS redrive policy](/fcj-workshop-template/images/5-Workshop/5.6-SQS-DLQ-and-S3-Data-Bucket/w-tin-04-sqs-redrive-policy.png)
