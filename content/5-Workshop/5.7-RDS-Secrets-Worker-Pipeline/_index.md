...
![RDS PostgreSQL Single-AZ summary](/fcj-workshop-template/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.1.png)

RDS uses private connectivity, public access is disabled, and the endpoint listens on port 5432.

![RDS private connectivity and endpoint](/fcj-workshop-template/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.2.png)

The Security Group allows only the backend/worker to access PostgreSQL on port 5432.

![RDS security group inbound rule](/fcj-workshop-template/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.3.png)
...
![RDS secret stored in Secrets Manager with value ](/fcj-workshop-template/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.4.png)
...
![RDS connectivity test from EC2 or worker](/fcj-workshop-template/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.5.png)
...
![Final alerts table in PostgreSQL](/fcj-workshop-template/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.6.png)
...
![AI worker systemd service status](/fcj-workshop-template/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.7.png)
...
![AI worker processed SQS message](/fcj-workshop-template/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.8.png)
...
![Final alert row stored in RDS](/fcj-workshop-template/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.9.png)
...
![Latest alert returned by backend API](/fcj-workshop-template/images/5-Workshop/5.7-RDS-Secrets-Worker-Pipeline/5.7.10.png)
